...
<section class="section section3">
  <div class="content">
    <div class="block">
      ...
      <p>
      Découvrez notre vaste catalogue de jeux vidéo disponibles sur Storeo, votre plateforme d'échange ultime. Que vous soyez nostalgique des classiques rétro ou à la recherche des derniers titres populaires, notre catalogue regorge de possibilités pour satisfaire tous les joueurs.

Explorez des titres captivants dans toutes les catégories : action, aventure, jeux de rôle, stratégie, sport, et bien plus encore. Notre collection comprend des jeux pour toutes les plateformes, des consoles rétro aux derniers systèmes de jeu. </p>
      <a href="catalogue" class="button">Catalogue de jeux</a>
    </div>
