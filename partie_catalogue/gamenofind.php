...
<form action="traitement.php" method="POST">
  <h2>Dommage !</h2>
  <hr>
  <p>Le jeu que vous Recherchez n'est pas (encore) disponible, retentez votre chance.</p>
  ...
  <a href="catalogue" class="button">Rechercher à nouveau</a>
</form>
